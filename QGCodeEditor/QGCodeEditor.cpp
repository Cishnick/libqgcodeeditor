...
QString QGCodeEditor::formatLine(QString text) {
    ...
    str.replace(("G([0-9]*)"), " G\\1");
    str.replace(("M([0-9]*)"), " M\\1");
    str.replace(("F([0-9]*)"), " F\\1");
    str.replace(("S([0-9]*)"), " S\\1");
    str.replace(("P([0-9]*)"), " P\\1");
    str.replace(("Q([0-9]*)"), " Q\\1");
    str.replace(("X([0-9]*)"), " X\\1");
    str.replace(("Y([0-9]*)"), " Y\\1");
    str.replace(("Z([0-9]*)"), " Z\\1");
    str.replace(("I([0-9]*)"), " I\\1");
    str.replace(("J([0-9]*)"), " J\\1");
    str.replace(("K([0-9]*)"), " K\\1");
